...
namespace AutoMapper.UnitTests
{
    namespace CustomMapping
    {
        ...
        public class When_mapping_from_one_property_type_to_another_via_constructor : AutoMapperSpecBase
        {
            private Dest _dest;
            ...
            {
                Mapper.CreateMap<Source, Dest>()
                    .ForMember(dest => dest.Value, opt => opt.MapFrom(src => int.Parse(src.Value.Substring(1))));
            }
            ...
            [Test]
            public void Should_map_from_source_property()
            {
